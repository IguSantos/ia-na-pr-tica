...
yahoo_finance_tool = Tool(
    ...
    func= lambda ticket: fetch_stock_price(ticket) # REVISAR
)
...
# CRIANDO A TASK PARA O AGENT ANTERIOR
getStockPrice = Task(
...
newsAnalyst = Agent(
    ...
    You're also master level analytics in the tradicional markets and have deep understanding of human psychology.
